...
class GoogleFinanceBacktest(object):
    ...
    def __init__(self, instruments, initialCash, fromYear, toYear, debugMode=True, csvStorage="./googlefinance", filterInvalidRows=True):
        ...
        self.__feed = googlefinance.build_feed(instruments, fromYear, toYear, storage=csvStorage, skipErrors=True, rowFilter=rowFilter if filterInvalidRows else None)
