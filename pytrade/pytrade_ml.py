...
from pytrade.algorithms import MLAnalysis as MLA
import pandas as pd
...
#
# # fromYear=2014 toYear=2016, training_buy_window_days=30, forecast_buy_window_days=5, training_sell_window_days=30, 80forecast_sell_window_days=80
...
algorithm = MLA.MLAnalysisTradingAlgorithm(feed=backtest.getFeed(), broker=backtest.getBroker(), riskFactor=0.05,
                                           ...
                                           forecast_buy_window_days=1, training_sell_window_days=30,
                                           forecast_sell_window_days=1, buy_result_function=buy_functions['BF1'],
                                           sell_result_function=sell_functions['SF7'])
backtest.attachAlgorithm(algorithm)
backtest.run()
